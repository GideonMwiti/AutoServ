...
<div class="d-flex justify-content-between align-items-center mb-4 pt-3">
    <h3 class="mb-0 fw-bold text-primary-custom">Sales Management</h3>
    <a href="?module=sales&action=add" class="btn custom-btn-primary"><i class="fa-solid fa-plus me-1"></i> Add New</a>
</div>
